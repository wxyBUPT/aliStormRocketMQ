...
public class RaceConfig implements Serializable{
    ...
    public static String JstormTopologyName = "forrace";

    public static String MetaConsumerGroup = "forUseiii";
    ...
    public static String KeySetForTmTb= "tbTbKeySetoo";
    public static String KeySetForRatio = "KeySetForRatiooo";
